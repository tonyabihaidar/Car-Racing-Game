...
const AESFullTextDecryption: React.FC = () => {
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      doc.text(`AES Full Text Decryption - ${multiResult.mode} Mode`, pageWidth / 2, yPos, {
        align: "center",
      });
      yPos += 15;
      ...
      doc.save(`AES-${keySize}_${multiResult.mode}_decryption_block-${selectedBlockIndex + 1}.pdf`);
  ...
  const downloadDecryptedFile = () => {
    ...
    try {
      const plaintext = multiResult.plaintextHex;
      
      // Convert hex to text
      const bytes = hexToBytes(plaintext);
      ...
      a.href = url;
      a.download = `decrypted_${uploadedFileName || "text"}_${mode}.txt`;
  ...
  const handleDecryptFullText = () => {
    try {
      ...
      const result = decryptTextMultiBlock(
        fullCiphertext.replace(/\s+/g, ""),
        keyHex,
        mode,
      ...
      showToast("Ciphertext decrypted.");
    } catch (err: any) {
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px", width: "100%" }}>
          ...
          <div>
            ...
            <p className="aes-subtitle">
              Decrypt any ciphertext using AES-128/192/256 in 5 modes,
          ...
          <div className="aes-section">
            ...
            <div className="aes-form-group">
              ...
              <p className="aes-help">
                ...
                Estimated blocks: {Math.ceil(fullCiphertext.replace(/\s+/g, "").length / 32) || 0}
              </p>
            </div>
